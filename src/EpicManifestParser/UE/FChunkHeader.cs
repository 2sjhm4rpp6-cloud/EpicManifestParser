...
internal readonly struct FChunkHeader
{
    ...
    internal FChunkHeader(ref ManifestReader reader)
    {
        ...
        int archiveSizeLeft = reader.Length - startPos;
        uint32 expectedSerializedBytes = ChunkHeaderVersionSizes[(int32)EChunkVersion.Original];
        ...
        bool success = reader.Position - startPos == expectedSerializedBytes;
